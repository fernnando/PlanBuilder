...
/**
 * Helper class to show alert dialogs.
 */
...
class AlertDialogHelper(internal var context: Context) {
     ...
     * @param isCancelable
     */
    @JvmOverloads fun showAlertDialog(title: String, message: String, positive: String, negative: String,
                                      neutral: String, from: Int, isCancelable: Boolean = false) {
